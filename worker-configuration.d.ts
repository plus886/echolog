/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8cb58e3ce3ffca7cb28d9f256bceec59)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		FORMOSA_MICROCMS_SERVICE_DOMAIN: string;
		FORMOSA_MICROCMS_API_KEY: string;
		MICROCMS_MANAGEMENT_API_KEY: string;
		MICROCMS_WEBHOOK_SECRET: string;
		FORMOSA_MICROCMS_WEBHOOK_SECRET: string;
		FORMOSA_MICROCMS_MANAGEMENT_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MICROCMS_SERVICE_DOMAIN" | "MICROCMS_API_KEY" | "FORMOSA_MICROCMS_SERVICE_DOMAIN" | "FORMOSA_MICROCMS_API_KEY" | "MICROCMS_MANAGEMENT_API_KEY" | "MICROCMS_WEBHOOK_SECRET" | "FORMOSA_MICROCMS_WEBHOOK_SECRET" | "FORMOSA_MICROCMS_MANAGEMENT_API_KEY" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "PUBLIC_SITE_URL" | "ANTHROPIC_API_KEY" | "BYPASS_AUTH">> {}
}
