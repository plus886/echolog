...
// .is-rippling class を一瞬付与する。CSS 側で k-ripple-dip animation
...
// link 内の各 .k-nav-char に対し、originX (cursor 入射点) との距離を
// --ripple-delay として書き込み、is-rippling を付け直す。force reflow を
// 挟むので、同じ link への連続 enter でアニメが頭から再生される。
